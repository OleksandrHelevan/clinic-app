...
public class DoctorController {
    ...
    @GetMapping
    public ResponseEntity<Page<DoctorResponse>> getDoctorsBySpecialization(@RequestParam Specialization specialization,
